                    ...
                    <CardContent className="p-5">
                        <ul className="space-y-3 text-sm leading-relaxed text-ink/70">
                            ...
                            <li className="flex gap-2.5">
                                <span className="mt-1.5 h-1 w-1 shrink-0 rounded-full bg-ink/30" />
                                <span>
                                    Panduan kesiapsiagaan yang ditampilkan bersifat umum dan dikurasi dari
                                    imbauan resmi BNPB serta standar AQI US EPA — bukan peringatan dini
                                    (early warning) real-time dari BNPB/BPBD, dan tidak menggantikan arahan
                                    resmi dari petugas setempat saat kondisi darurat.
                                </span>
                            </li>
                        </ul>
                    </CardContent>
